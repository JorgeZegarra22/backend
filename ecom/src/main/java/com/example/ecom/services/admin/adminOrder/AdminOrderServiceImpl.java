...
public class AdminOrderServiceImpl implements AdminOrderService{
    ...
    public AnalyticsResponse calculateAnalytics(){
        ...
        Long delivery = orderRepository.countByOrderStatus(OrderStatus.Delivered);

        return new AnalyticsResponse(placed, shipped, delivery, currentMonthOrders, previousMonthOrders, currentMonthEarnings, previousMonthEarnings);
    }
    ...
    public Long getTotalOrdersForMonth(int month, int year){
        ...
        // Mover el calendario al final del mes especificado
